...
echo ""
echo -e "${CYAN}Your browser will open the bot's Steam profile.${NC}"
echo -e "${CYAN}Click 'Add as Friend' and the bot will accept automatically.${NC}"
echo -e "${GRAY}--------------------------------------------------------------${NC}"
echo ""
read -rp "Press Enter to open the Steam profile in your browser"
xdg-open "$BOT_PROFILE" 2>/dev/null || echo "Open this URL manually: $BOT_PROFILE"
echo ""
